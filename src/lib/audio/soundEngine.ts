// The sound palette: felt piano + a woody knock (CLAUDE.md §4). All samples
// are pre-generated by scripts/generate-sounds.mjs and pre-loaded here —
// nothing is synthesized at runtime. Tick pitches live on a C pentatonic
// scale, in key with the nocturne loops. (Note: the pitched-note files keep
// their historical `marimba-XX.wav` names; the voice inside is felt piano.)
