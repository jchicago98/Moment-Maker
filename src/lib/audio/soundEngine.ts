// The sound palette: felt piano + a woody knock (CLAUDE.md §4), used sparingly
// — dragging is silent; sound marks only the decisive moments (throw lock-in,
// deal-in, gift knocks, reveal). All samples are pre-generated by
// scripts/generate-sounds.mjs and pre-loaded here — nothing is synthesized at
// runtime. Notes live on a C pentatonic scale, in key with the nocturne loops.
// (The pitched-note files keep their historical `marimba-XX.wav` names; the
// voice inside is felt piano.)
...
/** Locked-in throw = quick two-note rise, brighter with harder flings. */
